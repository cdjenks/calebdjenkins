            ...
            <div className="row content-main">
                ...
                <div className="card col-sm-10 col-lg-6">
                    ...
                    <section className="card-body">
                        ...
                        <p className="bio-text">I am a newly minted but motivated web developer looking to break into web development professionally. To this
                        ...
                        I now look forward to translating my problem solving abilities into the profession of computer programming and continuing to develop my skillset
                        in this arena. At the end of a day I want to have something to point to and say "I helped bring that into existence," and even when computer
